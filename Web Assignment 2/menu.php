...
$sqlst = "SELECT * FROM tbl_menu WHERE category = 'Starters' ORDER BY price";
$sqlma = "SELECT * FROM tbl_menu WHERE category = 'Mains' ORDER BY price";
$sqlde = "SELECT * FROM tbl_menu WHERE category = 'Desserts' ORDER BY price";
$sqldr = "SELECT * FROM tbl_menu WHERE category = 'Drinks' ORDER BY price";
?>
  </head>
  <body>
	  <div id="wrapper">
...
$id = $row["ID"];
$sqlfav = "SELECT * FROM favourites WHERE username = '$username' AND ItemID = '$id'";
...
if($count > 0){
	...
	echo "<p>" .
		 ...
		 "<td width = 15%><a href=detail.php?ID=" . $row["ID"] . "><img src=images/details.png width=100%></a></td>" .
		 "<td width = 15%><a href=addbasket.php?ID=" . $row["ID"] . "><img src=images/basket.png width=100%></a></td>" .
		 "<td width = 15%><a href=addfavourite.php?ID=" . $row["ID"] . "><img src=images/favourites.png width=100%></a></td>" .
	     "</tr>" .
		 "</table>" .
		 "</p>";
	}
