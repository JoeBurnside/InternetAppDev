  ...
  <body>
	  <div id="wrapper">
		...
		echo "<p>" .
		 ...
		 "<td width = 15%><a href=deleteorderitem.php?ID=" . $orderid . "&Item=" . $rowitems["ItemID"] . "><img src=images/delete.png width=50%></a>" .
	     "</tr>" .
		 "</table>" .
		 "</p>";
		}
