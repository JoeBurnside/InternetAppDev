...
Price: <br> <input type="text" name="price" required="true" value="<?php echo $price; ?>"><br><br>
Category: <br> <select name="category">
								<option value="Starters"<?php if($category=="Starters") echo "selected=\"selected\""; ?>>Starters</option>
								<option value="Mains"<?php if($category=="Mains") echo "selected=\"selected\""; ?>>Mains</option>
								<option value="Desserts"<?php if($category=="Desserts") echo "selected=\"selected\""; ?>>Desserts</option>
								<option value="Drinks"<?php if($category=="Drinks") echo "selected=\"selected\""; ?>>Drinks</option>
							</select><br><br>
