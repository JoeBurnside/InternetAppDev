...
while($row = mysqli_fetch_assoc($resultbsk)){
	...
	echo "<tr>" .
		 "<td width = 14%></td>" .
		 "<td width = 15%><img src=getImage.php?ID=" . $row["ID"] . " width=100%></td>" .
		 "<td width = 10%></td>" .
		 "<td width = 30%>" . $row["Name"] . "</td>" .
		 "<td width = 10%></td>" .
		 "<td width = 4%><a href=removebasket.php?ID=" . $row["ID"] . "><img src=images/minus.png width=60%></a></td>" .
         "<td width = 2%>". $row["Quantity"] . "</td>" .
		 "<td width = 1%></td>" .
		 "<td width = 4%><a href=addbasket.php?ID=" . $row["ID"] . "><img src=images/add.png width=60%></a></td>" .
		 "<td width = 10%></td>" .
	...
	echo "<h1>Number of Items: " . $row["sumquant"] . 
	"<br><br>Total Price: £" . $row["sumprice"] . "</h1>" .
	"<br><h1><a href=placeorder2.php><img src=images/order.png width=20%></a></h1>";
}
else {
