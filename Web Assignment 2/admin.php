...
?>
  ...
  <body>
	  <div id="wrapper">
		...
		<h1>Admin Page</h1>
		<div id="buttons">
		<h1><a href=changepassword.php><img src=images/password.png width=40%></a></h1>
		<h1><a href=editmenu.php><img src=images/editmenu.png width=40%></a></h1>
		</div>
		<div id="buttons">
		<h1><a href=vieworders.php><img src=images/orders.png width=40%></a></h1>
		<h1><a href=editusers.php><img src=images/users.png width=40%></a></h1>
		</div>
		<h1><a href=logout.php><img src=images/logout.png width=20%></a></h1>
		</article>
		<div id="sidebar">
				<h1>Basket</h1>
