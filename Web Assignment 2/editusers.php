  ...
  <body>
	  <div id="wrapper">
		...
		echo "<p>" .
		 ...
		 "<td width = 15%>";
		 if ($row["Level"] == 'user') {
		 echo "<a href=makeadmin.php?ID=" . $row["username"] . "><img src=images/makeadmin.png width=70%></a>";
		 }
		 else {
		 echo "<a href=removeadmin.php?ID=" . $row["username"] . "><img src=images/removeadmin.png width=70%></a>";
		 }
		 echo "</td>" .
		 "<td width = 15%><a href=deleteuser.php?ID=" . $row["username"] . "><img src=images/delete.png width=70%></a>" .
		 "</tr></table>";
		 }
		?>
		<br><br>
